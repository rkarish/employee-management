    ...
    public partial class CreateDatabase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2021, 12, 7, 3, 7, 1, 274, DateTimeKind.Local).AddTicks(3920), null, "Software Engineer", "Robert", null, "Karish" });

            migrationBuilder.InsertData(
                table: "Skills",
                columns: new[] { "Id", "DateCreated", "DateUpdated", "Description", "Name" },
                values: new object[] { 1, new DateTime(2021, 12, 7, 3, 7, 1, 274, DateTimeKind.Local).AddTicks(3770), null, "Best programming language.", "Python" });
